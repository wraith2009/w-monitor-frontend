...
export function AddMonitorModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      >
        <DialogContent className="bg-[#1f1f1f] border-gray-700/50 text-white max-w-2xl max-h-[85vh] overflow-y-auto shadow-2xl">
          <motion.div
          ...
          >
            <DialogHeader className="border-b border-gray-700/30 pb-4">
              ...
              <DialogDescription className="text-gray-400">
                Configure a new monitor to track your service uptime and
                performance
              </DialogDescription>
            </DialogHeader>
          </motion.div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 py-4">
            ...
            >
              <TabsList className="grid w-full grid-cols-2 bg-gray-800/60 backdrop-blur-sm border border-gray-700/30 h-fit">
                <motion.div
                  className="absolute top-1 bottom-1 bg-purple-600/30 rounded-md border border-purple-500/40 shadow-lg shadow-purple-500/20"
                ...
                <TabsTrigger
                  ref={tabRefs.basic}
                  value="basic"
                  className="relative z-10 px-4 py-2 data-[state=active]:bg-transparent data-[state=active]:text-purple-300"
                >
                  <motion.span
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="bg-gray-800/40 border-gray-600/50 text-white placeholder-gray-500 focus:border-purple-500/50 focus:ring-purple-500/20 transition-all duration-200"
                    />
                    <AnimatePresence>
                      {errors.websiteName && (
                        <motion.p
                  ...
                  >
                    <div className="space-y-2">
                      ...
                      >
                        <SelectTrigger className="bg-gray-800/40 border-gray-600/50 text-white hover:bg-gray-700/50 focus:border-purple-500/50 transition-all duration-200">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent className="bg-gray-800 border-gray-600 shadow-2xl backdrop-blur-lg">
                          {httpMethods.map((method) => (
                            <SelectItem
                              key={method}
                              value={method}
                              className="text-white hover:bg-purple-600/20 focus:bg-purple-600/20 transition-colors duration-150"
                            >
                              {method}
                            </SelectItem>
                          ))}
                  ...
                  >
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">
                        Monitor will be created but not started immediately
                      </p>
                    </div>
                    <Switch
                      ...
                      className="w-11 h-6 relative inline-flex items-center rounded-full border border-gray-600 transition-colors data-[state=checked]:bg-purple-600 bg-gray-700"
                    >
            ...
            >
              <Button
                ...
                variant="outline"
                onClick={onClose}
                className="border-gray-600 text-gray-400 hover:text-white hover:border-gray-500 transition-all duration-200"
              >
                Cancel
              </Button>
              <Button
                ...
                className="bg-purple-600 hover:bg-purple-500 text-white shadow-lg hover:shadow-purple-500/25 transition-all duration-200 disabled:opacity-50"
              >
                {isSubmitting ? (
                  <>
